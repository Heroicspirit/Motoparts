            ...
            <div className="bg-[#11141e] border border-slate-800/80 rounded-xl p-6 lg:p-7 space-y-6">
              ...
              <div className="flex gap-4 items-start py-2">
                ...
                <div className="flex-1 min-w-0 space-y-1">
                  ...
                  <div className="text-[11px] text-slate-400">$1,249.00</div>
                </div>
              </div>
              ...
              <div className="space-y-4 text-xs border-t border-b border-slate-900 py-5">
                <div className="flex justify-between items-center text-slate-400">
                  <span>Subtotal</span>
                  <span className="text-white font-medium">$1,249.00</span>
                </div>
                <div className="flex justify-between items-center text-slate-400">
                  <span>Shipping</span>
              ...
              <div className="flex justify-between items-baseline pt-1">
                ...
                <span className="text-xl font-black text-white">Rs 1,249.99</span>
              </div>

              {/* Confirm Pay Submission Button CTA */}
              <Link href="/user/checkout/success" className="w-full bg-[#a2beff] hover:bg-[#8eb0ff] text-slate-900 font-bold text-xs py-3.5 px-4 rounded-xl transition flex items-center justify-center gap-2 group shadow-md shadow-blue-500/5 text-center">
                Confirm & Pay <ArrowRight size={14} className="group-hover:translate-x-0.5 transition" />
              </Link>
